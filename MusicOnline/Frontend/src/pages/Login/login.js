        ...
        <div id="form-Login">
          ...
          >
            <Form.Item style={{ marginBottom: 3, marginTop: 65 }}>
              <Divider style={{ marginBottom: 5, fontSize: 19 }} orientation="center">CHÀO MỪNG BẠN ĐẾN VỚI MUSIC!</Divider>
            </Form.Item>
            ...
            <Form.Item >
              <Link className='link-register' to="/register">Chưa có tài khoản?Đăng ký</Link>
            </Form.Item>
          </Form>
        </div>
      </div>
